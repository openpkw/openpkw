...
-- -----------------------------------------------------
-- Table `openpkw2`.`PERIPHERIAL_COMMITTEE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `openpkw2`.`PERIPHERIAL_COMMITTEE` (
...
CREATE TABLE IF NOT EXISTS `openpkw2`.`USER` (
  ...
  INDEX `fk_USER_PERIPHERIAL_COMMITTEE1_idx` (`PERIPHERIAL_COMMITTEE_ID` ASC)  COMMENT '',
  CONSTRAINT `fk_USER_USER_TYPE1`
    FOREIGN KEY (`USER_TYPE_USER_TYPE_ID`)
    REFERENCES `openpkw2`.`USER_TYPE` (`USER_TYPE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USER_PERIPHERIAL_COMMITTEE1`
    FOREIGN KEY (`PERIPHERIAL_COMMITTEE_ID`)
    REFERENCES `openpkw2`.`PERIPHERIAL_COMMITTEE` (`PERIPHERIAL_COMMITTEE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `openpkw2`.`PERIPHERIAL_COMMITTEE_ADDRESS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `openpkw2`.`PERIPHERIAL_COMMITTEE_ADDRESS` (
