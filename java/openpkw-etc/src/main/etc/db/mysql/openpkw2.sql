...
CREATE TABLE IF NOT EXISTS `mydb`.`USER` (
  ...
  `USER_TYPE_USER_TYPE_ID` INT NOT NULL COMMENT '',
  ...
  INDEX `fk_USER_USER_TYPE1_idx` (`USER_TYPE_USER_TYPE_ID` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`PERIPHERIAL_COMMITTEE_ADDRESS` (
  ...
  `BUILDING_NUMBER` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`PHOTO` (
  ...
  `PERIPHERIAL_COMMITTEE_PKW_ID` VARCHAR(64) NOT NULL COMMENT '',
