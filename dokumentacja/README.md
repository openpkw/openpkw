...
Katalog [**master\pliki klk**] (https://github.com/openpkw/openpkw/tree/master/pliki%20klk) - zawiera przykładowe pliki definicyjne w formacie (dotychczas używanym) .klk  
  ...
  *  **plik [KLK_180801_2015-08-26_19-46.json]  (https://github.com/openpkw/openpkw/blob/master/pliki%20klk/KLK_180801_2015-08-26_19-46.json) - plik KLK z nowej wersji programu WOW (test ogólnopolski 27 sierpnia 2015 r.) - Referendum ogólnopolskie 6 września 2015 r. - gmina miasto Leżajsk.**  
  *  **plik [protokol-180801-5.json] (https://github.com/openpkw/openpkw/blob/master/pliki%20klk/protokol-180801-5.json) - plik protokołu z Komisji Obwodowej Nr 5 w Leżajsku (test ogólnopolski 27 sierpnia 2015 r.) - Referendum 6 września 2015 r.**  
